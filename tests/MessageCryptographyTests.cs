...
namespace GlitchedEpistle.Client.Tests
{
    ...
    {
        private readonly IMessageCryptography crypto = new MessageCryptography(new SymmetricCryptography(), new AsymmetricCryptographyRSA(), new BrotliUtility(), new BrotliUtilityAsync(), new InMemoryLogger());
