...
namespace GlitchedPolygons.GlitchedEpistle.Client.Services.Web.Convos
{
    ...
    public class MessageSender : IMessageSender
    {
        ...
        public MessageSender(User user, UserSettings userSettings, IUserService userService, IConvoPasswordProvider convoPasswordProvider, IConvoService convoService, IAsymmetricCryptographyRSA rsa, IMessageCryptography crypto, ICompressionUtilityAsync gzip)
        {
            this.rsa = rsa;
            this.user = user;
            this.gzip = gzip;
